        ...
        children: [
          {
            ...
            innerText: 'total',
            attributes: { 'data-sort-period': 'total' },
          },
          {
            tag: 'button',
            classes: ['btn', 'btn__details'],
            innerText: 'last day',
            attributes: { 'data-sort-period': 'lastDay' },
          },
          {
            tag: 'button',
            classes: ['btn', 'btn__details', 'active_btn'],
            innerText: 'all',
            attributes: { 'data-sort-count': 'all' },
          },
          {
            tag: 'button',
            classes: ['btn', 'btn__details'],
            innerText: 'per 100 ths',
            attributes: { 'data-sort-count': 'per100Ths' },
          },
        ],
      },
    ],
